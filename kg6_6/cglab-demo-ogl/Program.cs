...
public abstract class CGLabDemoOGL : OGLApplicationTemplate<CGLabDemoOGL>
{
    ...
    [DisplayNumericProperty(75d, 1d, "Высота", 0d, 200d)]
    public abstract double H { get; set; }

    [DisplayCheckerProperty(false, "Изометрия")]
    public virtual bool Isometric { get; set; }
    ...
    private void UpdatePerspectve(OpenGL gl)
    {
        ...
        else pMatrix = Perspective(60, (double)w / h, 0.1, 100);
